    ...
    return (
        <div  className="container intro">
            <div id="intro-section" className="col-md-12">
                ...
                <h1 className="name-color">Rizvy Ahamed</h1>
                ...
                <div className="icon">
                    <a className="icon2" href="https://github.com/rizvy97" target="_blank" rel="noopener noreferrer"><FaGithubSquare /></a>
                    <a className="icon2" href="https://www.linkedin.com/in/rizvy-ahamed-bb4458150/" target="_blank" rel="noopener noreferrer"><AiFillLinkedin /></a>
                    <a className="icon2" href="https://twitter.com/rizvyahamed97" target="_blank" rel="noopener noreferrer"><AiFillTwitterCircle /></a>
                    <a className="icon2" href="https://youtube.com/channel/UCCbMuSoSGiD1lKwqsgZbqhw" target="_blank" rel="noopener noreferrer"><AiFillYoutube /></a>
                </div>
            </div>
        </div>
    );
